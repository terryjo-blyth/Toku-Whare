...
function Feeling (props) {
  ...
  const entryFeeling = feelings.filter((feeling) => { return feeling.name === props.feeling })
  // console.log('entry feeling ', entryFeeling)
  const feelingSvg = entryFeeling[0].svg
  return (
    <>
      <span dangerouslySetInnerHTML={parseHTML(feelingSvg)}></span>
    </>
  )
}
